...
export default class ListaPessoas extends Component {
    ...
    // sempre que o compontente for montado executa alguma coisa (função)
    componentDidMount() {
        this.refreshPessoas();        
    }

    // chama a função de retornar todas as pessoas, se der certo, 
    // imprime no console a resposta, e seta o state pessoas para 
    // receber o conteúdo
    refreshPessoas() {
